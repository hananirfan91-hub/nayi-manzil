...
export default function Disclaimer() {
  return (
    <>
      <SEO title="Disclaimer | Nayi Manzil" description="Official Disclaimer for Nayi Manzil's digital story and brand." />
      <div className="pt-32 pb-24 container mx-auto px-4 max-w-4xl">
        <div className="prose prose-invert prose-cyan max-w-none">
          ...
          <p className="text-slate-300 leading-relaxed mb-6">
            Nayi Manzil assumes no responsibility for errors or omissions in the contents on the Service. In no event shall Nayi Manzil be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service. Nayi Manzil reserves the right to make additions, deletions, or modification to the contents on the Service at any time without prior notice.
          </p>
